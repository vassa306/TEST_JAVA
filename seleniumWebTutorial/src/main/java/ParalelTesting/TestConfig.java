...
public class TestConfig{
	...
	public static String from = "vassa306@gmail.com";
	public static String password = "qweautrwhjjlvosg";
	public static String[] to ={"vassa306@gmail.com"};
	...
	public static String attachmentName="error.zip";
